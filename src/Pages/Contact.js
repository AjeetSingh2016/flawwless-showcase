  ...
  return (
    <div>
      ...
      <p>
        ...
        translate the app into other languages or make derivative versions. <strong>This is to make sure to our user that the contents of this app are collected/copied/saved as is from the intrenet to our databse. <a href="Flawwless.in">Flawwless.in </a>accepts no liablity for the content of this app</strong>
      </p>{" "}
      <p>
        Flawwless.in is committed to ensuring that the app is as useful and
      ...
      <p>
        The Flawwless app stores and processes personal data that you have
        ...
        features and it could mean that the Flawwless app won’t work properly or
        at all.
      </p>{" "}
      <div>
        <p>
      ...
      <p>
        You should be aware that there are certain things that Flawwless.in will
        ...
        Wi-Fi or provided by your mobile network provider, but Flawwless.in
      ...
      <p>
        Along the same lines, Flawwless.in cannot always take responsibility for
        ...
        avail the Service, Flawwless.in cannot accept responsibility.
      </p>{" "}
      <p>
        With respect to Flawwless.in’s responsibility for your use of the app,
        ...
        it available to you. Flawwless.in accepts no liability for any loss,
      ...
      <p>
        ...
        using the app. Flawwless.in does not promise that it will always update
      ...
      <p>These terms and conditions are effective as of 2022-12-10</p>{" "}
      <p></p>
      <p>
      ...
      <p>
        ...
        do not hesitate to contact us at flawwlesscontact@gmail.com.
      </p>{" "}
      <p>
